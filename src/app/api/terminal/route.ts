...
// âââ Yahoo Finance fetcher âââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Score calculators ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
function calcMacroScore(
  ...
  if (fearGreedValue != null) {
    if (fearGreedValue >= 70) score += 3; // greed â cautiously positive
...
// âââ Next FOMC meeting dates (hardcoded schedule, update annually) ââââââââââ
...
// âââ Sector ETF list ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Main data builder ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
async function buildTerminalData() {
  ...
  const [
    ...
    fetchYahooQuotes(['^GSPC', '^IXIC', '^VIX', 'DX-Y.NYB', '^TNX', 'GLD']),
  ...
  // âââ Calculate scores from real data âââââââââââââââââââââââââââââââââââ
  ...
  return {
    ...
    scoringWeights: {
      volatility: { weight: Math.round(volatilityScore * 0.19), label: `+${Math.round(volatilityScore * 0.19)}` },
      ...
      macro: { weight: Math.round(macroScore * 0.16), label: `+${Math.round(macroScore * 0.16)}` },
    },
    fearGreed: fearGreed ? {
