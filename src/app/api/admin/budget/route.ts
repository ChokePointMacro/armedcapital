...
import { getAllBudgets, getAgentBudget, updateBudget, getModelRoutes, getAvailableModels, seedBudgets } from '@/lib/agentBus';
...
export async function GET() {
  try {
    await safeAuth();
    seedBudgets(); // ensure core agents have budgets initialized
