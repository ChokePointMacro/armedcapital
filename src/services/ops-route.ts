...
// ââ Daily Task Definitions âââââââââââââââââââââââââââââââââââââââââââââââââââ
// Tasks that should run every day â market monitoring, briefs, scans
...
const DAILY_OPS: OpsTask[] = [
  {
    ...
    prompt: 'Generate a comprehensive daily macro intelligence brief for Armed Capital. Cover: (1) Treasury yields and rate expectations â DGS2, DGS10, T10Y2Y, T5YIE, FEDFUNDS, (2) Equity market structure â SPX, QQQ, VIX positioning and key levels, (3) Crypto market â BTC dominance, ETH/SOL relative strength, DeFi TVL trends, (4) Macro indicators â latest CPI, employment (ICSA), CFTC positioning, TGA balance, (5) Sentiment â Fear & Greed index, put/call ratios, funding rates, (6) Key risks and catalysts for next 48 hours with probability ratings. Format as a structured intelligence brief with confidence ratings per section. Include a 3-sentence executive summary at the top.',
  ...
  },
  {
    ...
    estimated_cost: '$0.00',
    category: 'data',
    prompt: 'Run a full daily anomaly scan across all monitored assets. Check: (1) Volume spikes >2x 7-day average on any watchlist equity or crypto, (2) Price moves >3% in 24h on any top-20 crypto, (3) BTC dominance shift >1% from yesterday, (4) DeFi TVL changes >5% on any top-10 chain, (5) Stablecoin market cap changes >1%, (6) FRED yield curve â any inversion changes, (7) Fear & Greed index move >10 points. Flag all anomalies with severity (low/medium/high/critical) and potential impact assessment.',
  ...
  },
  {
    ...
    estimated_cost: '$0.00',
    category: 'data',
    prompt: 'Force-refresh all enrichment data sources and report status: (1) FRED â yield curve, breakevens, jobless claims, fed funds, (2) Finnhub â market quotes, earnings calendar, (3) CoinGecko â top 10 crypto, BTC dominance, (4) CNN Fear & Greed â current reading and trend, (5) BLS â CPI, PPI, employment if new data, (6) CFTC COT â E-mini, 10Y, Gold, Euro FX, BTC positioning, (7) Treasury â TGA balance, debt, auction schedule, (8) DefiLlama â chain TVL, stablecoin flows. Report freshness timestamps and flag any stale (>24h) or failed sources.',
  ...
  },
  {
    ...
    estimated_cost: '$0.00',
    category: 'data',
    prompt: 'Compile a digest of all TradingView webhook signals received in the last 24 hours. Group by: (1) Signal type â buy, sell, alert, indicator trigger, (2) Asset â which symbols fired the most signals, (3) Timeframe â intraday vs daily signals, (4) Confluence â any assets with 3+ signals in same direction. Summarize the overall signal landscape and highlight the highest-conviction setups.',
  ...
  },
  {
    ...
    category: 'social',
    prompt: 'Using today\'s macro intelligence brief, generate 3-5 tweet-ready posts for @ChokepointMacro. Requirements: (1) Each tweet must be <280 chars, (2) Lead with the most impactful data point, (3) Include relevant $TICKER or #hashtags, (4) Mix of insight tweets, data callouts, and risk warnings, (5) Stagger content for posting throughout the day. Queue all posts as pending for approval before posting. Do NOT post directly â queue only.',
    run_endpoint: '/api/auto-schedule',
  },
];

// ââ Weekly Task Definitions ââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const WEEKLY_OPS: OpsTask[] = [
  {
    ...
    estimated_cost: '$0.15',
    category: 'intelligence',
    prompt: 'Generate the weekly Armed Capital risk assessment. Deep analysis of: (1) 7-day returns and drawdowns across BTC, ETH, SOL, SPX, QQQ, DXY, GOLD, US10Y with context vs 30-day and 90-day trends, (2) Volatility regime classification â VIX level and term structure, realized vs implied vol divergence, crypto IV percentile, (3) Sector rotation from CFTC COT â which sectors are institutions rotating into/out of, (4) Yield curve evolution â shape changes, credit spread widening/tightening, (5) DeFi protocol health â TVL changes by chain, top protocol inflows/outflows, (6) Net positioning changes for key CME futures. Assign an overall portfolio risk score 1-10 with directional bias (risk-on / risk-off / neutral) and confidence level. Include a "What could go wrong" section with 3 tail risk scenarios.',
    run_endpoint: '/api/generate',
  },
  {
    agent_id: 'intelligence',
    ...
    estimated_cost: '$0.12',
    category: 'intelligence',
    prompt: 'Produce the weekly Bitcoin confluence signal report. Layer analysis: (1) Technical â weekly chart structure, key support/resistance, 200-week MA position, weekly RSI/MACD, (2) Macro â real rates trend, DXY weekly close, global M2 trajectory, (3) On-chain â exchange reserve trend, miner outflow behavior, long-term holder supply, MVRV ratio, (4) Sentiment â weekly Fear & Greed average, social volume trend, perpetual funding rate average, (5) Positioning â CFTC BTC futures net positioning, options max pain and put/call ratio, ETF flows. Score each layer 1-5 (bearish to bullish). Produce an overall confluence score, identify high-conviction vs low-conviction calls, and compare with last week\'s report for trend changes.',
    run_endpoint: '/api/generate',
  },
  {
    agent_id: 'market-scanner',
    ...
    estimated_cost: '$0.00',
    category: 'data',
    prompt: 'Comprehensive weekly Fed rate analysis: (1) Full yield curve â DGS1M through DGS30 with week-over-week changes, (2) Inflation â T5YIE/T10YIE breakevens vs realized CPI, PCE, (3) Labor â ICSA claims trend, UNRATE, payrolls, (4) Financial conditions â DGS10 vs FEDFUNDS spread, (5) Fed funds futures implied probabilities for next 3 meetings, (6) Historical comparison â current curve shape vs prior hiking/cutting cycles. Produce a Fed rate path forecast with probability weightings for next 3 meetings.',
  ...
  },
  {
    ...
    estimated_cost: '$0.00',
    category: 'data',
    prompt: 'Audit all data enrichment sources for the past week: (1) Uptime â how many API calls succeeded vs failed per source, (2) Freshness â average data lag per source, any sources consistently stale, (3) Accuracy â any known data discrepancies or corrections, (4) Rate limits â how close to limits per source (FRED 120/min, Finnhub 60/min, CoinGecko 10-30/min), (5) Cost â any sources approaching paid tier thresholds, (6) Recommendations â sources to add, remove, or replace. Produce a data infrastructure health score 1-10.',
    run_endpoint: '/api/usage',
  },
  {
    agent_id: 'auto-scheduler',
    ...
    estimated_cost: '$0.001',
    category: 'social',
    prompt: 'Review the past week\'s social posting performance for @ChokepointMacro: (1) Posts scheduled vs posted vs failed â success rate, (2) Posting cadence â gaps, bunching, optimal time analysis, (3) Content type performance â which topics/formats got the most engagement, (4) Error analysis â what caused failures, are they systemic, (5) Queue health â any stale pending posts, any orphaned content, (6) Recommendations â optimal posting schedule for next week, content themes to focus on. Produce actionable social ops plan for the coming week.',
    run_endpoint: '/api/auto-schedule',
  },
  {
    agent_id: 'intelligence',
    ...
    description: 'Evaluate experimental data sources and models from the past week â ship/kill decisions.',
    priority: 'low',
    risk_level: 'medium',
    risk_score: 5,
    estimated_cost: '$0.15',
    category: 'intelligence',
    prompt: 'Review the R&D pipeline for Armed Capital: (1) Active experiments â what alternative data sources or analytical models are being tested, (2) Signal quality â which experiments are producing actionable signals vs noise, (3) Cost-benefit â cost of running each experiment vs value of insights generated, (4) Integration readiness â which experiments are ready to ship to production, (5) Kill list â experiments to terminate due to low ROI or data quality issues. Produce ship/continue/kill recommendation for each active experiment with justification.',
    run_endpoint: '/api/generate',
  },
];

// ââ Execution Engine âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
function generateRecommendations(results: OpsResult[], type: 'daily' | 'weekly'): string[] {
  ...
  if (criticalFailed.length > 0) {
    recs.push(`URGENT: ${criticalFailed.length} critical task(s) failed â ${criticalFailed.map(f => f.agent_name).join(', ')}. Investigate immediately.`);
  }
  ...
  if (failed.length > 2) {
    recs.push(`${failed.length} tasks failed â possible systemic issue. Check Vercel function logs and API key rotation schedule.`);
  }
...
// ââ GET: Return ops task definitions (preview before running) ââââââââââââââââ
...
// ââ POST: Execute daily or weekly ops ââââââââââââââââââââââââââââââââââââââââ
...
export async function POST(req: NextRequest) {
  try {
      ...
      try {
        ...
        if (!budgetCheck.allowed) {
          results.push({
            ...
            elapsed_ms: 0,
            cost: '$0.00',
            summary: `Skipped â budget limit: ${budgetCheck.reason}`,
          });
          continue;
        }
        await logAuditEvent({
    ...
    } catch { /* table may not exist â non-critical */ }
